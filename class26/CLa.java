    ...
    class Squar implements Shape {
        ...
        class TestCla{
            public static void main(String[] args) {
                com.syntax.class26.class26.Shape[]shapes={new com.syntax.class26.class26.Squar(),new com.syntax.class26.class26.Circle()};
                for(com.syntax.class26.class26.Shape shape:shapes){
                    shape.calculateArea();
